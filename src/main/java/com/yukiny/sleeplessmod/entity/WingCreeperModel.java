...
public class WingCreeperModel extends ModelBase {
    ...
    public WingCreeperModel()
    {
        this(0.0F);
    }

    public WingCreeperModel(float p_i46366_1_)
    {
        int i = 6;
        ...
        this.batRightWing = new ModelRenderer(this, 45, 3);
        this.batRightWing.addBox(-12.0F, 1.0F, 1.5F, 10, 16, 1);
        this.batOuterRightWing = new ModelRenderer(this, 45, 3);
        this.batOuterRightWing.setRotationPoint(-12.0F, 1.0F, 1.5F);
        this.batOuterRightWing.addBox(-8.0F, 1.0F, 0.0F, 8, 12, 1);
        this.batLeftWing = new ModelRenderer(this, 45, 45);
        this.batLeftWing.mirror = true;
        this.batLeftWing.addBox(2.0F, 1.0F, 1.5F, 10, 16, 1);
        this.batOuterLeftWing = new ModelRenderer(this, 45, 3);
        this.batOuterLeftWing.mirror = true;
        this.batOuterLeftWing.setRotationPoint(12.0F, 1.0F, 1.5F);
        this.batOuterLeftWing.addBox(0.0F, 1.0F, 0.0F, 8, 12, 1);
        this.body.addChild(this.batRightWing);
        this.body.addChild(this.batLeftWing);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
    {
        ...
        this.leg4.rotateAngleX = MathHelper.cos(limbSwing * 0.6662F);
        this.batRightWing.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.batLeftWing.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.batRightWing.rotateAngleY = MathHelper.cos(ageInTicks * 1.3F * 0.2f) * (float)Math.PI * 0.25F;
